class AppConstants {
  static const int splashDelay = 3; // ? this is the delay time for the splash screen in seconds
  static const int sliderAnimationDelay = 500; // ? this is the delay time for the slider animation in milliseconds
}
